...
public class MainActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener, Question1.OnFragmentInteractionListener {
    ...
    //This part may not need anymore, since there is no id.
        ...
        expListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v,
                ...
                if(groupPosition==0 &&childPosition==1){
                    ...
                    manager.beginTransaction().replace(R.id.layout, fragment1).commit();
                }
                else if(groupPosition==0 &&childPosition==2) {
                    Intent toNext = new Intent(MainActivity.this, NV_Que3.class);
